...
class Worker:
    ...
    def __init__(
        ...
        self.data_reader = VideoDataReader(
            video_height, video_width, timeout, find_format_timeout, max_format_tries, video_format=encode_format, sample_rate=sample_rate)
    ...
    def download_shard(
        ...
        for key in loader:
            key, streams, error_message = self.data_reader(key)
            vid_stream = streams['mp4']
            try:
